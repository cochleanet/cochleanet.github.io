...
!function (e, t) {
    ...
    function r(e, n, r, i) {
        if (ee.acceptData(e)) {
            var a, o, s = ee.expando, u = "string" == typeof n, l = e.nodeType, c = l ? ee.cache : e,
                d = l ? e[s] : e[s] && s;
    ...
    function i(e, t, n) {
        if (ee.acceptData(e)) {
            var r, i, a, s = e.nodeType, u = s ? ee.cache : e, l = s ? e[ee.expando] : ee.expando;
            if (u[l]) {
    ...
    function o(e) {
        var t;
        for (t in e) if (("data" !== t || !ee.isEmptyObject(e[t])) && "toJSON" !== t) return !1;
        return !0
    }
    ...
    function g(e, t) {
        if (1 === t.nodeType && ee.hasData(e)) {
            var n, r, i, a = ee._data(e), o = ee._data(t, a), s = a.events;
            if (s) for (n in delete o.handle, o.events = {}, s) for (r = 0, i = s[n].length; i > r; r++) ee.event.add(t, n, s[n][r]);
    ...
    function y(e, n) {
        ...
        if (!o) for (o = [], r = e.childNodes || e; null != (i = r[a]); a++) !n || ee.nodeName(i, n) ? o.push(i) : ee.merge(o, y(i, n));
    ...
    function x(e, t) {
        if (t in e) return t;
        for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = ht.length; i--;) if ((t = ht[i] + n) in e) return t;
        return r
    }
    ...
    function E(e, t) {
        var n = ee(t.createElement(e)).appendTo(t.body), r = ee.css(n[0], "display");
        return n.remove(), r
    }
    ...
    function S(e, t, n, r) {
        ...
        }); else if (n || "object" !== ee.type(t)) r(e, t); else for (i in t) S(e + "[" + i + "]", t[i], n, r)
    }
    ...
    function q(e, t, n) {
        var r, i, a = 0, o = Xt.length, s = ee.Deferred().always(function () {
            delete u.elem
        }), u = function () {
            if (i) return !1;
        ...
        for (function (e, t) {
            var n, r, i, a, o;
            for (n in e) if (r = ee.camelCase(n), i = t[r], a = e[n], ee.isArray(a) && (i = a[1], a = e[n] = a[0]), n !== r && (e[r] = a, delete e[n]), (o = ee.cssHooks[r]) && "expand" in o) for (n in a = o.expand(a), delete e[r], a) n in e || (e[n] = a[n], t[n] = i); else t[r] = i
        }(c, l.opts.specialEasing); o > a; a++) if (r = Xt[a].call(l, e, c, l.opts)) return r;
        return function (e, t) {
            ee.each(t, function (t, n) {
                for (var r = (Vt[t] || []).concat(Vt["*"]), i = 0, a = r.length; a > i; i++) if (r[i].call(e, t, n)) return
            })
    ...
    var R, O, B = e.document, z = e.location, I = e.jQuery, W = e.$, $ = {}, X = [], V = "3.4.1", U = X.concat,
        ...
        ie = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, ae = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, oe = /^[\],:{}\s]*$/,
        se = /(?:^|:|,)(?:\s*\[)+/g, ue = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,
        le = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, ce = /^-ms-/, de = /-([\da-z])/gi,
        fe = function (e, t) {
    ...
    ee.fn = ee.prototype = {
        jquery: V, constructor: ee, init: function (e, n, r) {
            var i, a;
            if (!e) return this;
            if ("string" == typeof e) {
                ...
                if (i[1]) {
                    if (n = n instanceof ee ? n[0] : n, ee.merge(this, ee.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : B, !0)), ae.test(i[1]) && ee.isPlainObject(n)) for (i in n) ee.isFunction(this[i]) ? this[i](n[i]) : this.attr(i, n[i]);
                    return this
                }
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[1] || {}, u = 2), "object" == typeof s || ee.isFunction(s) || (s = {}), l === u && (s = this, --u); l > u; u++) if (null != (e = arguments[u])) for (n in e) r = s[n], s !== (i = e[n]) && (c && i && (ee.isPlainObject(i) || (a = ee.isArray(i))) ? (a ? (a = !1, o = r && ee.isArray(r) ? r : []) : o = r && ee.isPlainObject(r) ? r : {}, s[n] = ee.extend(c, o, i)) : i !== t && (s[n] = i));
        return s
    }, ee.extend({
        noConflict: function (t) {
            ...
            var i = 0, a = e.length, o = n(e);
            if (r) {
                if (o) for (; a > i && !1 !== t.apply(e[i], r); i++) ; else for (i in e) if (!1 === t.apply(e[i], r)) break
            } else if (o) for (; a > i && !1 !== t.call(e[i], i, e[i]); i++) ; else for (i in e) if (!1 === t.call(e[i], i, e[i])) break;
            return e
            ...
            if (n(e)) for (; o > a; a++) null != (i = t(e[a], a, r)) && (s[s.length] = i); else for (a in e) null != (i = t(e[a], a, r)) && (s[s.length] = i);
            return U.apply([], s)
            ...
            if ("object" === ee.type(r)) for (u in a = !0, r) ee.access(e, n, u, r[u], !0, o, s); else if (i !== t && (a = !0, ee.isFunction(i) || (s = !0), c && (s ? (n.call(e, i), n = null) : (c = n, n = function (e, t, n) {
        ...
        if (!O) if (O = ee.Deferred(), "complete" === B.readyState) setTimeout(ee.ready); else if (B.addEventListener) B.addEventListener("DOMContentLoaded", pe, !1), e.addEventListener("load", ee.ready, !1); else {
    ...
    ee.Callbacks = function (e) {
        ...
        var n, r, i, a, o, s, u = [], l = !e.once && [], c = function (t) {
            for (n = e.memory && t, r = !0, s = a || 0, a = 0, o = u.length, i = !0; u && o > s; s++) if (!1 === u[s].apply(t[0], t[1]) && e.stopOnFalse) {
                n = !1;
                break
            }
            ...
            add: function () {
                ...
                return u && ee.each(arguments, function (e, t) {
                    for (var n; (n = ee.inArray(t, u, n)) > -1;) u.splice(n, 1), i && (o >= n && o--, s >= n && s--)
                }), this
            }, has: function (e) {
        ...
        Deferred: function (e) {
                    ...
                    state: function () {
                        ...
                        return ee.Deferred(function (n) {
                            ee.each(t, function (t, a) {
                                var o = a[0], s = ee.isFunction(e[t]) && e[t];
                                i[a[1]](function () {
            ...
            var t, n, r, i = 0, a = Q.call(arguments), o = a.length,
                s = 1 !== o || e && ee.isFunction(e.promise) ? o : 0, u = 1 === s ? e : ee.Deferred(),
                l = function (e, n, r) {
                    return function (i) {
                        n[e] = this, r[e] = arguments.length > 1 ? Q.call(arguments) : i, r === t ? u.notifyWith(n, r) : --s || u.resolveWith(n, r)
                    }
                };
            if (o > 1) for (t = Array(o), n = Array(o), r = Array(o); o > i; i++) a[i] && ee.isFunction(a[i].promise) ? a[i].promise().done(l(i, r, a)).fail(u.reject).progress(l(i, n, t)) : --s;
    ...
    ee.extend({
        ...
        queue: function (e, n) {
            ...
            var r, i = 1, a = ee.Deferred(), o = this, s = this.length, u = function () {
                --i || a.resolveWith(o, [o])
            };
    ...
    var ve, ye, be = /[\t\r\n]/g, xe = /\r/g, we = /^(?:input|select|textarea|button|object)$/i, Te = /^(?:a|area)$/i,
        ...
        ke = /^(?:checked|selected)$/i, Fe = ee.support.getSetAttribute, Ne = ee.support.input;
    ee.fn.extend({
        attr: function (e, t) {
            ...
            if (u) for (t = (e || "").match(ne) || []; s > o; o++) if (r = 1 === (n = this[o]).nodeType && (n.className ? (" " + n.className + " ").replace(be, " ") : " ")) {
            ...
            return ee.isFunction(e) ? this.each(function (n) {
                ...
                if ("string" === n) for (var i, a = 0, o = ee(this), s = t, u = e.match(ne) || []; i = u[a++];) s = r ? s : !o.hasClass(i), o[s ? "addClass" : "removeClass"](i); else ("undefined" === n || "boolean" === n) && (this.className && ee._data(this, "__className__", this.className), this.className = this.className || !1 === e ? "" : ee._data(this, "__className__") || "")
            })
        }, hasClass: function (e) {
            for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace(be, " ").indexOf(t) >= 0) return !0;
            return !1
        }, val: function (e) {
            var n, r, i, a = this[0];
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, a = "select-one" === e.type || 0 > i, o = a ? null : [], s = a ? i + 1 : r.length, u = 0 > i ? s : a ? i : 0; s > u; u++) if (!(!(n = r[u]).selected && u !== i || (ee.support.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && ee.nodeName(n.parentNode, "optgroup"))) {
        ...
        removeAttr: function (e, t) {
            var n, r, i = 0, a = t && t.match(ne);
            if (a && 1 === e.nodeType) for (; n = a[i++];) r = ee.propFix[n] || n, Ce.test(n) ? !Fe && ke.test(n) ? e[ee.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : ee.attr(e, n, ""), e.removeAttribute(Fe ? n : r)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
        ...
        get: function (e, n) {
            var r = ee.prop(e, n), i = "boolean" == typeof r && e.getAttribute(n),
    ...
    var Ee = /^(?:input|select|textarea)$/i, Se = /^key/, De = /^(?:mouse|contextmenu)|click/,
        Ae = /^(?:focusinfocus|focusoutblur)$/, je = /^([^.]*)(?:\.(.+)|)$/;
    ee.event = {
        global: {},
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (g && (u = g.events)) {
                for (l = (t = (t || "").match(ne) || [""]).length; l--;) if (p = m = (s = je.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), p) {
        ...
        trigger: function (n, r, i, a) {
            var o, s, u, l, c, d, f, p = [i || B], h = n.type || n, m = n.namespace ? n.namespace.split(".") : [];
            if (s = u = i = i || B, 3 !== i.nodeType && 8 !== i.nodeType && !Ae.test(h + ee.event.triggered) && (h.indexOf(".") >= 0 && (m = h.split("."), h = m.shift(), m.sort()), c = 0 > h.indexOf(":") && "on" + h, (n = n[ee.expando] ? n : new ee.Event(h, "object" == typeof n && n)).isTrigger = !0, n.namespace = m.join("."), n.namespace_re = n.namespace ? RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, n.result = t, n.target || (n.target = i), r = null == r ? [n] : ee.makeArray(r, [n]), f = ee.event.special[h] || {}, a || !f.trigger || !1 !== f.trigger.apply(i, r))) {
                ...
                for (o = 0; (s = p[o++]) && !n.isPropagationStopped();) n.type = o > 1 ? l : f.bindType || h, (d = (ee._data(s, "events") || {})[n.type] && ee._data(s, "handle")) && d.apply(s, r), (d = c && s[c]) && ee.acceptData(s) && d.apply && !1 === d.apply(s, r) && n.preventDefault();
        ...
        fix: function (e) {
            ...
            var t, n, r = e, i = ee.event.fixHooks[e.type] || {}, a = i.props ? this.props.concat(i.props) : this.props;
        ...
        setup: function () {
            return !ee.nodeName(this, "form") && (ee.event.add(this, "click._submit keypress._submit", function (e) {
                var n = e.target, r = ee.nodeName(n, "input") || ee.nodeName(n, "button") ? n.form : t;
        ...
        on: function (e, n, r, i, a) {
            ...
            if (null == r && null == i ? (i = n, r = n = t) : null == i && ("string" == typeof n ? (i = r, r = t) : (i = r, r = n, n = t)), !1 === i) i = u; else if (!i) return this;
        ...
        function o(e, t, n, r) {
            ...
            return function (e, t, n, r) {
                ...
                if (!r && 1 === l.length) {
                    ...
                    for (i = le.needsContext.test(e) ? -1 : a.length - 1; i >= 0 && (o = a[i], !C.relative[s = o.type]); i--) if ((u = C.find[s]) && (r = u(o.matches[0].replace(ve, ye), ce.test(a[0].type) && t.parentNode || t))) {
        ...
        function p(e, t, n) {
            var r = t.dir, i = n && "parentNode" === t.dir, a = I++;
            return t.first ? function (t, n, a) {
                ...
                } else for (; t = t[r];) if (1 === t.nodeType || i) if ((u = (l = t[R] || (t[R] = {}))[r]) && u[0] === c) {
        ...
        function g(e, t, n, r, a, o) {
            return r && !r[R] && (r = g(r)), a && !a[R] && (a = g(a, o)), i(function (i, o, s, u) {
                var l, c, d, f = [], p = [], h = o.length, g = i || b(t || "*", s.nodeType ? [s] : s, []),
                    v = !e || !i && t ? g : m(g, f, e, s, u), y = n ? a || (i ? e : h || r) ? [] : o : v;
        ...
        function v(e) {
            ...
            }]; i > s; s++) if (n = C.relative[e[s].type]) c = [p(h(c), n)]; else {
        ...
        function y(e, t) {
            var n = 0, r = t.length > 0, a = e.length > 0, s = function (i, s, u, l, c) {
                var d, f, p, h = [], g = 0, v = "0", y = i && [], b = null != c, x = S,
                    w = i || a && C.find.TAG("*", c && s.parentNode || s), k = z += null == x ? 1 : Math.E;
                for (b && (S = s !== A && s, T = n); null != (d = w[v]); v++) {
                    if (a && d) {
                        for (f = 0; p = e[f]; f++) if (p(d, s, u)) {
                            l.push(d);
                            break
                        }
                        b && (z = k, T = ++n)
        ...
        var w, T, C, k, F, N, E, S, D, A, j, L, _, q, M, H, P, R = "sizzle" + -new Date, O = e.document, B = {}, z = 0,
            I = 0, W = r(), $ = r(), X = r(), V = typeof t, U = [], Y = U.pop, Q = U.push, G = U.slice,
            J = U.indexOf || function (e) {
                for (var t = 0, n = this.length; n > t; t++) if (this[t] === e) return t;
                return -1
            }, Z = "[\\x20\\t\\r\\n\\f]", K = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", te = K.replace("w", "w#"),
            ne = "\\[" + Z + "*(" + K + ")" + Z + "*(?:([*^$|!~]?=)" + Z + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + te + ")|)|)" + Z + "*\\]",
            re = ":(" + K + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + ne.replace(3, 8) + ")*)|.*)\\)|)",
            ie = RegExp("^" + Z + "+|((?:^|[^\\\\])(?:\\\\.)*)" + Z + "+$", "g"), ae = RegExp("^" + Z + "*," + Z + "*"),
            oe = RegExp("^" + Z + "*([\\x20\\t\\r\\n\\f>+~])" + Z + "*"), se = RegExp(re), ue = RegExp("^" + te + "$"),
            le = {
                ID: RegExp("^#(" + K + ")"),
                CLASS: RegExp("^\\.(" + K + ")"),
                NAME: RegExp("^\\[name=['\"]?(" + K + ")['\"]?\\]"),
            ...
            }, ce = /[\x20\t\r\n\f]*[+~]/, de = /\{\s*\[native code\]\s*\}/, fe = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
            pe = /^(?:input|select|textarea|button)$/i, he = /^h\d$/i, me = /'|\\/g,
        ...
        for (w in F = o.isXML = function (e) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        var l, c, d, f, p, h, m = a !== o ? "nextSibling" : "previousSibling", g = t.parentNode,
                        ...
                        if (g) {
                            ...
                            if (h = [o ? g.firstChild : g.lastChild], o && y) {
                                for (p = (l = (c = g[R] || (g[R] = {}))[e] || [])[0] === z && l[1], f = l[0] === z && l[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();) if (1 === d.nodeType && ++f && d === t) {
                                    c[e] = [z, p, f];
                                    break
                                }
                            } else if (y && (l = (t[R] || (t[R] = {}))[e]) && l[0] === z) f = l[1]; else for (; (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[R] || (d[R] = {}))[e] = [z, f]), d !== t));) ;
            ...
            pseudos: {
                not: i(function (e) {
                    ...
                    return ue.test(e || "") || o.error("unsupported lang: " + e), e = e.replace(ve, ye).toLowerCase(), function (t) {
                        var n;
                        do {
    ...
    ee.fn.extend({
        find: function (e) {
            ...
            for (var n, r = 0, i = this.length, a = [], o = Me.test(e) || "string" != typeof e ? ee(e, t || this.context) : 0; i > r; r++) for (n = this[r]; n && n.ownerDocument && n !== t && 11 !== n.nodeType;) {
    ...
    var Pe = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        Re = / jQuery\d+="(?:null|\d+)"/g, Oe = RegExp("<(?:" + Pe + ")[\\s/>]", "i"), Be = /^\s+/,
        ze = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Ie = /<([\w:]+)/,
        We = /<tbody/i, $e = /<|&#?\w+;/, Xe = /<(?:script|style|link)/i, Ve = /^(?:checkbox|radio)$/i,
        Ue = /checked\s*(?:[^=]|=\s*.checked.)/i, Ye = /^$|\/(?:java|ecma)script/i, Qe = /^true\/(.*)/,
        Ge = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Je = {
    ...
    Je.optgroup = Je.option, Je.tbody = Je.tfoot = Je.colgroup = Je.caption = Je.thead, Je.th = Je.td, ee.fn.extend({
        text: function (e) {
            ...
            e = U.apply([], e);
            var i, a, o, s, u, l, c = 0, d = this.length, m = this, g = d - 1, v = e[0], b = ee.isFunction(v);
            ...
            if (d && (a = (i = ee.buildFragment(e, this[0].ownerDocument, !1, this)).firstChild, 1 === i.childNodes.length && (i = a), a)) {
                ...
                if (s) for (l = o[o.length - 1].ownerDocument, ee.map(o, h), c = 0; s > c; c++) u = o[c], Ye.test(u.type || "") && !ee._data(u, "globalEval") && ee.contains(l, u) && (u.src ? ee.ajax({
                    url: u.src,
                    type: "GET",
                    dataType: "script",
                    async: !1,
        ...
        clone: function (e, t, n) {
            ...
            if (ee.support.html5Clone || ee.isXMLDoc(e) || !Oe.test("<" + e.nodeName + ">") ? s = e.cloneNode(!0) : (Ze.innerHTML = e.outerHTML, Ze.removeChild(s = Ze.firstChild)), !(ee.support.noCloneEvent && ee.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ee.isXMLDoc(e))) for (r = y(s), i = y(e), o = 0; null != (a = i[o]); ++o) r[o] && v(a, r[o]);
            if (t) if (n) for (i = i || y(e), r = r || y(s), o = 0; null != (a = i[o]); o++) g(a, r[o]); else g(e, s);
            return (r = y(s, "script")).length > 0 && m(r, !u && y(e, "script")), r = i = a = null, s
        }, buildFragment: function (e, t, n, r) {
            for (var i, a, o, s, u, l, c, f = e.length, p = d(t), h = [], g = 0; f > g; g++) if ((a = e[g]) || 0 === a) if ("object" === ee.type(a)) ee.merge(h, a.nodeType ? [a] : a); else if ($e.test(a)) {
                ...
                if (!ee.support.leadingWhitespace && Be.test(a) && h.push(t.createTextNode(Be.exec(a)[0])), !ee.support.tbody) for (c = (a = "table" !== o || We.test(a) ? "<table>" !== u[1] || We.test(a) ? 0 : s : s.firstChild) && a.childNodes.length; c--;) ee.nodeName(l = a.childNodes[c], "tbody") && !l.childNodes.length && a.removeChild(l);
                for (ee.merge(h, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                s = p.lastChild
            } else h.push(t.createTextNode(a));
            for (s && p.removeChild(s), ee.support.appendChecked || ee.grep(y(h, "input"), b), g = 0; a = h[g++];) if ((!r || -1 === ee.inArray(a, r)) && (i = ee.contains(a.ownerDocument, a), s = y(p.appendChild(a), "script"), i && m(s), n)) for (c = 0; a = s[c++];) Ye.test(a.type || "") && n.push(a);
            return s = null, p
        }, cleanData: function (e, n) {
            for (var r, i, a, o, s = 0, u = ee.expando, l = ee.cache, c = ee.support.deleteExpando, d = ee.event.special; null != (a = e[s]); s++) if ((n || ee.acceptData(a)) && (r = (i = a[u]) && l[i])) {
                if (r.events) for (o in r.events) d[o] ? ee.event.remove(a, o) : ee.removeEvent(a, o, r.handle);
                l[i] && (delete l[i], c ? delete a[u] : a.removeAttribute !== t ? a.removeAttribute(u) : a[u] = null, X.push(i))
            }
        }
    });
    var Ke, et, tt, nt = /alpha\([^)]*\)/i, rt = /opacity\s*=\s*([^)]*)/, it = /^(top|right|bottom|left)$/,
        at = /^(none|table(?!-c[ea]).+)/, ot = /^margin/, st = RegExp("^(" + te + ")(.*)$", "i"),
        ut = RegExp("^(" + te + ")(?!px)[a-z%]+$", "i"), lt = RegExp("^([+-])=(" + te + ")", "i"), ct = {BODY: "block"},
        dt = {position: "absolute", visibility: "hidden", display: "block"}, ft = {letterSpacing: 0, fontWeight: 400},
        pt = ["Top", "Right", "Bottom", "Left"], ht = ["Webkit", "O", "Moz", "ms"];
    ee.fn.extend({
        css: function (e, n) {
        ...
        style: function (e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var a, o, s, u = ee.camelCase(n), l = e.style;
        ...
        var i, a, o, s = r || et(e), u = s ? s.getPropertyValue(n) || s[n] : t, l = e.style;
        ...
        var i, a, o, s = r || et(e), u = s ? s[n] : t, l = e.style;
        ...
        get: function (e, t) {
            ...
            var n = e.style, r = e.currentStyle, i = ee.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
        ...
        ee.support.reliableMarginRight || (ee.cssHooks.marginRight = {
            get: function (e, n) {
                return n ? ee.swap(e, {display: "inline-block"}, Ke, [e, "marginRight"]) : t
            }
    ...
    var mt = /%20/g, gt = /\[\]$/, vt = /\r?\n/g, yt = /^(?:submit|button|image|reset)$/i,
    ...
    var xt, wt, Tt = ee.now(), Ct = /\?/, kt = /#.*$/, Ft = /([?&])_=[^&]*/, Nt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Et = /^(?:GET|HEAD)$/, St = /^\/\//, Dt = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, At = ee.fn.load,
        jt = {}, Lt = {}, _t = "*/".concat("*");
    try {
        wt = z.href
    } catch (e) {
    ...
    xt = Dt.exec(wt.toLowerCase()) || [], ee.fn.load = function (e, n, r) {
        ...
        ajaxSettings: {
            ...
            converters: {"* text": e.String, "text html": !0, "text json": ee.parseJSON, "text xml": ee.parseXML},
        ...
        ajax: function (e, n) {
            function r(e, n, r, s) {
                ...
                2 !== x && (x = 2, u && clearTimeout(u), i = t, o = s || "", T.readyState = e > 0 ? 4 : 0, r && (b = function (e, n, r) {
                    ...
                    if (e.dataFilter && (t = e.dataFilter(t, e.dataType)), u[1]) for (n in e.converters) o[n.toLowerCase()] = e.converters[n];
                    for (; i = u[++s];) if ("*" !== i) {
                        if ("*" !== l && l !== i) {
                            if (!(n = o[l + " " + i] || o["* " + i])) for (r in o) if ((a = r.split(" "))[1] === i && (n = o[l + " " + a[0]] || o["* " + a[0]])) {
            ...
            var i, a, o, s, u, l, c, d, f = ee.ajaxSetup({}, n), p = f.context || f,
                h = f.context && (p.nodeType || p.jquery) ? ee(p) : ee.event, m = ee.Deferred(),
                g = ee.Callbacks("once memory"), v = f.statusCode || {}, y = {}, b = {}, x = 0, w = "canceled", T = {
    ...
    ee.ajaxSetup({
        ...
        var a, o, s,
            u = !1 !== n.jsonp && (Mt.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Mt.test(n.data) && "data");
    ...
    var Ht, Pt, Rt = 0, Ot = e.ActiveXObject && function () {
        var e;
        ...
        if (!n.crossDomain || ee.support.cors) return {
            send: function (i, a) {
                ...
                u.send(n.hasContent && n.data || null), r = function (e, i) {
                    var s, l, c, d, f;
                    try {
                        if (r && (i || 4 === u.readyState)) if (r = t, o && (u.onreadystatechange = ee.noop, Ot && delete Ht[o]), i) 4 !== u.readyState && u.abort(); else {
    ...
    var Bt, zt, It = /^(?:toggle|show|hide)$/, Wt = RegExp("^(?:([+-])=|)(" + te + ")([a-z%]*)$", "i"),
        $t = /queueHooks$/, Xt = [function (e, t, n) {
            ...
            "*": [function (e, t) {
                var n, r, i = this.createTween(e, t), a = Wt.exec(t), o = i.cur(), s = +o || 0, u = 1, l = 20;
                if (a) {
    ...
    ee.Animation = ee.extend(q, {
        ...
        constructor: M, init: function (e, t, n, r, i, a) {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return "string" != typeof e && (r = n, n = e, e = t), n && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                var t = !0, n = null != e && e + "queueHooks", a = ee.timers, o = ee._data(this);
                if (n) o[n] && o[n].stop && i(o[n]); else for (n in o) o[n] && o[n].stop && $t.test(n) && i(o[n]);
                for (n = a.length; n--;) a[n].elem !== this || null != e && a[n].queue !== e || (a[n].anim.stop(r), t = !1, a.splice(n, 1));
                (t || !r) && ee.dequeue(this, e)
            })
        }, finish: function (e) {
            return !1 !== e && (e = e || "fx"), this.each(function () {
                var t, n = ee._data(this), r = n[e + "queue"], i = n[e + "queueHooks"], a = ee.timers,
                    o = r ? r.length : 0;
        ...
        setOffset: function (e, t, n) {
            ...
            var i, a, o = ee(e), s = o.offset(), u = ee.css(e, "top"), l = ee.css(e, "left"), c = {}, d = {};
...
!function () {
    ...
    e.prototype = {
        init: function () {
            ...
            if (e = parseFloat(e), n.ctx || d(), void 0 !== e && e >= 0 && e <= 1) {
                ...
                for (var o = 0; o < n._howls.length; o++) if (!n._howls[o]._webAudio) for (var r = n._howls[o]._getSoundIds(), i = 0; i < r.length; i++) {
    ...
    n.prototype = {
        init: function (e) {
            ...
            var e = null;
            if (t.noAudio) this._emit("loaderror", null, "No audio support."); else {
                "string" == typeof this._src && (this._src = [this._src]);
                for (var n = 0; n < this._src.length; n++) {
                    var r, a;
                    if (this._format && this._format[n]) r = this._format[n]; else {
            ...
            var d = Math.max(0, s._seek > 0 ? s._seek : o._sprite[e][0] / 1e3),
                _ = Math.max(0, (o._sprite[e][0] + o._sprite[e][1]) / 1e3 - d), l = 1e3 * _ / Math.abs(s._rate);
            ...
            for (var a = i._getSoundIds(r), s = 0; s < a.length; s++) {
                ...
                if (u) {
                    if (r || i._stopFade(a[s]), i._webAudio && !u._muted) {
                        var d = t.ctx.currentTime, _ = d + o / 1e3;
            ...
            var a = this, s = t, u = n - t, d = Math.abs(u / .01), _ = Math.max(4, d > 0 ? o / d : o), l = Date.now();
            ...
            var e, n, o, r = this, i = arguments;
            if (0 === i.length) n = r._sounds[0]._id; else if (1 === i.length) {
            ...
            for (var a = 0; a < n.length; a++) if (o = r._soundById(n[a])) {
            ...
            var e, n, o = this, r = arguments;
            if (0 === r.length) n = o._sounds[0]._id; else if (1 === r.length) {
    ...
    o.prototype = {
        init: function () {
            ...
            var e = this._parent, n = t._muted || this._muted || this._parent._muted ? 0 : this._volume;
...
var Sound = function (t) {
    ...
    this.position = 0, this.duration = 0, this.noiseSuppressed = !1, this.soundId = null, this.timeoutId = null, this.events = {}, this.soundBefore = new Howl({
        src: ["sounds/" + t + "-before.wav"],
        mute: !0,
        onload: o,
        onend: i
    }), this.soundAfter = new Howl({src: ["sounds/" + t + "-after.wav"], mute: !0, onload: o, onend: i})
};
Sound.prototype.on = function (t, s) {
    ...
    if ("object" == typeof this.events[t]) for (o = (e = this.events[t].slice()).length, s = 0; s < o; s++) e[s].apply(this, i)
...
window.onload = init, $(document).foundation(), $(document).ready(function () {
    ...
    function () {
        var e = $("#noise-cancellation-switch"),
            n = $("#play-button"),
            a = $("#play-state"),
            i = $("#pause-state"),
            o = $("#select-sound"),
        ...
        function C() {
            ...
            (c = new Sound(o.id)).on("loaded", function () {
                ...
                h(), m = !1
            }), l.find("img").removeClass("opaque").filter(":eq(" + p + ")").addClass("opaque"), l.find("img").attr("alt", "CochleaNet"), t.removeClass().addClass("environment-container environment-" + o.id)
        }
