...
!function(e,t){"use strict";function n(e){var t=e.length,n=ee.type(e);return!ee.isWindow(e)&&(!(1!==e.nodeType||!t)||("array"===n||"function"!==n&&(0===t||"number"==typeof t&&t>0&&t-1 in e)))}
function r(e,n,r,i){if(ee.acceptData(e)){var a,o,s=ee.expando,u="string"==typeof n,l=e.nodeType,c=l?ee.cache:e,d=l?e[s]:e[s]&&s;if(d&&c[d]&&(i||c[d].data)||!u||r!==t)return d||(l?e[s]=d=X.pop()||ee.guid++:d=s),c[d]||(c[d]={},l||(c[d].toJSON=ee.noop)),("object"==typeof n||"function"==typeof n)&&(i?c[d]=ee.extend(c[d],n):c[d].data=ee.extend(c[d].data,n)),a=c[d],i||(a.data||(a.data={}),a=a.data),r!==t&&(a[ee.camelCase(n)]=r),u?null==(o=a[n])&&(o=a[ee.camelCase(n)]):o=a,o}}
function i(e,t,n){if(ee.acceptData(e)){var r,i,a,s=e.nodeType,u=s?ee.cache:e,l=s?e[ee.expando]:ee.expando;if(u[l]){if(t&&(r=n?u[l]:u[l].data)){ee.isArray(t)?t=t.concat(ee.map(t,ee.camelCase)):t in r?t=[t]:t=(t=ee.camelCase(t))in r?[t]:t.split(" ");for(i=0,a=t.length;a>i;i++)delete r[t[i]];if(!(n?o:ee.isEmptyObject)(r))return}
(n||(delete u[l].data,o(u[l])))&&(s?ee.cleanData([e],!0):ee.support.deleteExpando||u!=u.window?delete u[l]:u[l]=null)}}}
function a(e,n,r){if(r===t&&1===e.nodeType){var i="data-"+n.replace(ge,"-$1").toLowerCase();if("string"==typeof(r=e.getAttribute(i))){try{r="true"===r||"false"!==r&&("null"===r?null:+r+""===r?+r:me.test(r)?ee.parseJSON(r):r)}catch(e){}
ee.data(e,n,r)}else r=t}
return r}
function o(e){var t;for(t in e)if(("data"!==t||!ee.isEmptyObject(e[t]))&&"toJSON"!==t)return!1;return!0}
function s(){return!0}
function u(){return!1}
function l(e,t){do{e=e[t]}while(e&&1!==e.nodeType);return e}
function c(e,t,n){if(t=t||0,ee.isFunction(t))return ee.grep(e,function(e,r){return!!t.call(e,r,e)===n});if(t.nodeType)return ee.grep(e,function(e){return e===t===n});if("string"==typeof t){var r=ee.grep(e,function(e){return 1===e.nodeType});if(qe.test(t))return ee.filter(t,r,!n);t=ee.filter(t,r)}
return ee.grep(e,function(e){return ee.inArray(e,t)>=0===n})}
function d(e){var t=Pe.split("|"),n=e.createDocumentFragment();if(n.createElement)for(;t.length;)n.createElement(t.pop());return n}
...
function g(e,t){if(1===t.nodeType&&ee.hasData(e)){var n,r,i,a=ee._data(e),o=ee._data(t,a),s=a.events;if(s)for(n in delete o.handle,o.events={},s)for(r=0,i=s[n].length;i>r;r++)ee.event.add(t,n,s[n][r]);o.data&&(o.data=ee.extend({},o.data))}}
...
function y(e,n){var r,i,a=0,o=e.getElementsByTagName!==t?e.getElementsByTagName(n||"*"):e.querySelectorAll!==t?e.querySelectorAll(n||"*"):t;if(!o)for(o=[],r=e.childNodes||e;null!=(i=r[a]);a++)!n||ee.nodeName(i,n)?o.push(i):ee.merge(o,y(i,n));return n===t||n&&ee.nodeName(e,n)?ee.merge([e],o):o}
function b(e){Ve.test(e.type)&&(e.defaultChecked=e.checked)}
function x(e,t){if(t in e)return t;for(var n=t.charAt(0).toUpperCase()+t.slice(1),r=t,i=ht.length;i--;)if((t=ht[i]+n)in e)return t;return r}
...
function F(e,t,n){var r=!0,i="width"===t?e.offsetWidth:e.offsetHeight,a=et(e),o=ee.support.boxSizing&&"border-box"===ee.css(e,"boxSizing",!1,a);if(0>=i||null==i){if((0>(i=Ke(e,t,a))||null==i)&&(i=e.style[t]),ut.test(i))return i;r=o&&(ee.support.boxSizingReliable||i===e.style[t]),i=parseFloat(i)||0}
return i+k(e,t,n||(o?"border":"content"),r,a)+"px"}
function N(e){var t=B,n=ct[e];return n||("none"!==(n=E(e,t))&&n||((t=((tt=(tt||ee("<iframe frameborder='0' width='0' height='0'/>").css("cssText","display:block !important")).appendTo(t.documentElement))[0].contentWindow||tt[0].contentDocument).document).write("<!doctype html><html><body>"),t.close(),n=E(e,t),tt.detach()),ct[e]=n),n}
function E(e,t){var n=ee(t.createElement(e)).appendTo(t.body),r=ee.css(n[0],"display");return n.remove(),r}
function S(e,t,n,r){var i;if(ee.isArray(t))ee.each(t,function(t,i){n||gt.test(e)?r(e,i):S(e+"["+("object"==typeof i?t:"")+"]",i,n,r)});else if(n||"object"!==ee.type(t))r(e,t);else for(i in t)S(e+"["+i+"]",t[i],n,r)}
function D(e){return function(t,n){"string"!=typeof t&&(n=t,t="*");var r,i=0,a=t.toLowerCase().match(ne)||[];if(ee.isFunction(n))for(;r=a[i++];)"+"===r[0]?(r=r.slice(1)||"*",(e[r]=e[r]||[]).unshift(n)):(e[r]=e[r]||[]).push(n)}}
function A(e,n,r,i){function a(u){var l;return o[u]=!0,ee.each(e[u]||[],function(e,u){var c=u(n,r,i);return"string"!=typeof c||s||o[c]?s?!(l=c):t:(n.dataTypes.unshift(c),a(c),!1)}),l}
var o={},s=e===Lt;return a(n.dataTypes[0])||!o["*"]&&a("*")}
...
function o(e,t,n,r){var i,a,o,s,u,l,c,p,h,m;if((t?t.ownerDocument||t:O)!==A&&D(t),n=n||[],!e||"string"!=typeof e)return n;if(1!==(s=(t=t||A).nodeType)&&9!==s)return[];if(!L&&!r){if(i=fe.exec(e))if(o=i[1]){if(9===s){if(!(a=t.getElementById(o))||!a.parentNode)return n;if(a.id===o)return n.push(a),n}else if(t.ownerDocument&&(a=t.ownerDocument.getElementById(o))&&H(t,a)&&a.id===o)return n.push(a),n}else{if(i[2])return Q.apply(n,G.call(t.getElementsByTagName(e),0)),n;if((o=i[3])&&B.getByClassName&&t.getElementsByClassName)return Q.apply(n,G.call(t.getElementsByClassName(o),0)),n}
if(B.qsa&&!_.test(e)){if(c=!0,p=R,h=t,m=9===s&&e,1===s&&"object"!==t.nodeName.toLowerCase()){for(l=d(e),(c=t.getAttribute("id"))?p=c.replace(me,"\\$&"):t.setAttribute("id",p),p="[id='"+p+"'] ",u=l.length;u--;)l[u]=p+f(l[u]);h=ce.test(e)&&t.parentNode||t,m=l.join(",")}
if(m)try{return Q.apply(n,G.call(h.querySelectorAll(m),0)),n}catch(e){}finally{c||t.removeAttribute("id")}}}
return function(e,t,n,r){var i,a,o,s,u,l=d(e);if(!r&&1===l.length){if((a=l[0]=l[0].slice(0)).length>2&&"ID"===(o=a[0]).type&&9===t.nodeType&&!L&&C.relative[a[1].type]){if(!(t=C.find.ID(o.matches[0].replace(ve,ye),t)[0]))return n;e=e.slice(a.shift().value.length)}
for(i=le.needsContext.test(e)?-1:a.length-1;i>=0&&(o=a[i],!C.relative[s=o.type]);i--)if((u=C.find[s])&&(r=u(o.matches[0].replace(ve,ye),ce.test(a[0].type)&&t.parentNode||t))){if(a.splice(i,1),!(e=r.length&&f(a)))return Q.apply(n,G.call(r,0)),n;break}}
return N(e,l)(r,t,L,n,ce.test(e)),n}(e.replace(ie,"$1"),t,n,r)}
...
function d(e,t){var n,r,i,a,s,u,l,c=$[e+" "];if(c)return t?0:c.slice(0);for(s=e,u=[],l=C.preFilter;s;){for(a in(!n||(r=ae.exec(s)))&&(r&&(s=s.slice(r[0].length)||s),u.push(i=[])),n=!1,(r=oe.exec(s))&&(n=r.shift(),i.push({value:n,type:r[0].replace(ie," ")}),s=s.slice(n.length)),C.filter)!(r=le[a].exec(s))||l[a]&&!(r=l[a](r))||(n=r.shift(),i.push({value:n,type:a,matches:r}),s=s.slice(n.length));if(!n)break}
return t?s.length:s?o.error(e):$(e,u).slice(0)}
function f(e){for(var t=0,n=e.length,r="";n>t;t++)r+=e[t].value;return r}
function p(e,t,n){var r=t.dir,i=n&&"parentNode"===t.dir,a=I++;return t.first?function(t,n,a){for(;t=t[r];)if(1===t.nodeType||i)return e(t,n,a)}:function(t,n,o){var s,u,l,c=z+" "+a;if(o){for(;t=t[r];)if((1===t.nodeType||i)&&e(t,n,o))return!0}else for(;t=t[r];)if(1===t.nodeType||i)if((u=(l=t[R]||(t[R]={}))[r])&&u[0]===c){if(!0===(s=u[1])||s===T)return!0===s}else if((u=l[r]=[c])[1]=e(t,n,o)||T,!0===u[1])return!0}}
...
return n(function(){})});var Sound=function(t){var s=this,e=2;function o(){0===--e&&s.emit("loaded")}
function i(){s.emit("ended")}
this.position=0,this.duration=0,this.noiseSuppressed=!1,this.soundId=null,this.timeoutId=null,this.events={},this.soundBefore=new Howl({src:["sounds/"+t+"-before.wav"],mute:!0,onload:o,onend:i}),this.soundAfter=new Howl({src:["sounds/"+t+"-after.wav"],mute:!0,onload:o,onend:i})};Sound.prototype.on=function(t,s){"object"!=typeof this.events[t]&&(this.events[t]=[]),this.events[t].push(s)},Sound.prototype.emit=function(t){var s,e,o,i=[].slice.call(arguments,1);if("object"==typeof this.events[t])for(o=(e=this.events[t].slice()).length,s=0;s<o;s++)e[s].apply(this,i)},Sound.prototype.updateSeekPosition=function(){var t=this;this.position=this.soundBefore.seek(this.soundId),this.emit("update",this.position,this.duration),this.timeoutId=setTimeout(function(){t.updateSeekPosition()},100)},Sound.prototype.play=function(){this.soundBefore.mute(this.noiseSuppressed),this.soundAfter.mute(!this.noiseSuppressed),this.soundId=this.soundBefore.play(),this.soundAfter.play(),this.duration=this.soundBefore.duration(this.soundId),this.position=this.soundBefore.seek(this.soundId),this.emit("start",this.duration),this.updateSeekPosition()},Sound.prototype.pause=function(){this.soundBefore.pause(),this.soundAfter.pause(),clearTimeout(this.timeoutId)},Sound.prototype.stop=function(){this.soundBefore.stop(),this.soundAfter.stop(),this.duration=0,this.position=0,clearTimeout(this.timeoutId)},Sound.prototype.clearNoise=function(){this.noiseSuppressed=!this.noiseSuppressed,this.soundBefore.mute(this.noiseSuppressed),this.soundAfter.mute(!this.noiseSuppressed)},Sound.prototype.destroy=function(){this.stop(),this.soundBefore.unload(),this.soundAfter.unload(),this.soundBefore=null,this.soundAfter=null,this.events={},this.timeoutId=null};function init(){for(var e=document.getElementsByTagName("iframe"),n=0;n<e.length;n++)e[n].getAttribute("data-src")&&e[n].setAttribute("src",e[n].getAttribute("data-src"))}
window.onload=init,$(document).foundation(),$(document).ready(function(){$("#CloseWeWorkBanner").on("click",function(){$("#WeWorkBanner").removeClass("showPhBanner")}),$(".mob_conetnt").hide(),$("#ClosePhBanner").on("click",function(){$("#PhBanner").removeClass("showPhBanner")}),$("#CloseCookies").on("click",function(){$("#CookiesBanner").removeClass("showPhBanner")}),$("#intro").addClass("MacInterFace"),$(".Win").hide(),"Win32"==navigator.platform&&(window.productHuntUpcoming={appId:14902,position:"bottomLeft"},$("a.Mob").on("click",function(e){$("#mobile-sub").addClass("open"),$(".general-btn a.Win").attr({href:"javascript:void(0)",target:""})}),$("#mobile-sub .close").on("click",function(){$("#mobile-sub").removeClass("open")}),$(".Mac").hide(),$(".Win").show(),$("#intro").addClass("WinInterFace").removeClass("MacInterFace")),$("#burger").on("click",function(){$(this).toggleClass("open"),$("#mobile-nav").toggleClass("open")}),$(".mobile-nav li a").on("click",function(){$("#mobile-nav").hasClass("open")&&$("#mobile-nav").removeClass("open"),$("#burger").hasClass("open")&&$("#burger").removeClass("open")}),$("#HowItWorksList"),$("#HowItWorksList li").on("click",function(){var e=$(this).data("list");$(this).addClass("active").siblings().removeClass("active"),$('.image-wrapper .image[data-list="'+e+'"]').addClass("active").siblings().removeClass("active")}),$("#tweetsSlider").owlCarousel({loop:!1,autoplay:!0,nav:!0,autoplayHoverPause:!1,margin:10,responsiveClass:!0,smartSpeed:600,navSpeed:600,responsive:{0:{items:1,nav:!0,loop:!0},600:{items:1,nav:!0,loop:!0},1000:{items:3,nav:!0,loop:!1,margin:50}}})}),function(){var e=$("#noise-cancellation-switch"),n=$("#play-button"),a=$("#play-state"),i=$("#pause-state"),o=$("#select-sound"),s=$("#playing-progress"),t=$("#environment-container"),l=$("#environment-image"),r=$("#take-listen"),d=$("#app-icon"),c=null,m=!1,p=-1,u=Cookies.get("guideStep")||"play",f=[{id:"Fountain",name:"Fountain"},{id:"MusicCrowd",name:"Loud Music + Crowd"},{id:"StreetRain",name:"Street + Rain"},{id:"WorldTradeCenterNYK",name:"World Trade Center"},{id:"NewsStreet",name:"Pedestrian"},{id:"FireStation",name:"Fire Station"}];function v(){$(".guide").addClass("hidden"),$("#guide-"+u).removeClass("hidden")}
function g(e){"finished"!==u&&(u=e,Cookies.set("guideStep",u,{expires:7}),v())}
function C(){var o=f[p];(c=new Sound(o.id)).on("loaded",function(){n.attr("disabled",!1).on("click",function(e){e.preventDefault(),g("switch"),(m=!m)?(a.addClass("hidden"),i.removeClass("hidden"),c.play()):(i.addClass("hidden"),a.removeClass("hidden"),c.pause())}),e.on("click",function(n){n.preventDefault(),g("finished"),e.toggleClass("on").toggleClass("off"),d.toggleClass("on").toggleClass("off"),c.clearNoise()})}),c.on("update",function(e,n){var a,i;a=e,i=n,s.width(Math.round(a/i*100)+"%")}),c.on("ended",function(){h(),m=!1}),l.find("img").removeClass("opaque").filter(":eq("+p+")").addClass("opaque"),l.find("img").attr("alt","CochleaNet"),t.removeClass().addClass("environment-container environment-"+o.id)}
function h(){i.addClass("hidden"),a.removeClass("hidden"),s.width(0)}
function b(){c&&(c.destroy(),h(),n.attr("disabled",!0).off("click"),i.addClass("hidden"),a.removeClass("hidden"),e.removeClass("on").addClass("off").off("click"),d.removeClass("on").addClass("off"),c=null,m=!1)}
v(),$("#mute-target").Morphext({animation:"flipInX",separator:"|",speed:3e3}),r.on("click",function(e){e.preventDefault(),$("html, body").animate({scrollTop:t.offset().top},500)}),o.on("click","span",function(e){var n=$(this).parent(),a=n.index();e.preventDefault(),a!==p&&(n.addClass("selected").siblings().removeClass("selected"),p=a,b(),C())}),o.append(f.map(function(e){return'<li><span  data-id="'+e.id+'">'+e.name+"</span></li>"})),l.append(f.map(function(e){return'<img src="'+"images/environments/bg-"+e.id+'.jpg" />'})),o.find("span:first").trigger("click")}();$(document).ready(function(){$("#CloseWeWorkBanner").on("click",function(){$("#WeWorkBanner").removeClass("showPhBanner")}),$(".mob_conetnt").hide(),$("#ClosePhBanner").on("click",function(){$("#PhBanner").removeClass("showPhBanner")}),$("#CloseCookies").on("click",function(){$("#CookiesBanner").removeClass("showPhBanner")}),$("#intro").addClass("MacInterFace"),$(".Win").hide(),"Win32"==navigator.platform&&(window.productHuntUpcoming={appId:14902,position:"bottomLeft"},$("a.Mob").on("click",function(e){$("#mobile-sub").addClass("open"),$(".general-btn a.Win").attr({href:"javascript:void(0)",target:""})}),$("#mobile-sub .close").on("click",function(){$("#mobile-sub").removeClass("open")}),$(".Mac").hide(),$(".Win").show(),$("#intro").addClass("WinInterFace").removeClass("MacInterFace")),$("#burger").on("click",function(){$(this).toggleClass("open"),$("#mobile-nav").toggleClass("open")}),$(".mobile-nav li a").on("click",function(){$("#mobile-nav").hasClass("open")&&$("#mobile-nav").removeClass("open"),$("#burger").hasClass("open")&&$("#burger").removeClass("open")}),$("#HowItWorksList"),$("#HowItWorksList li").on("click",function(){var e=$(this).data("list");$(this).addClass("active").siblings().removeClass("active"),$('.image-wrapper .image[data-list="'+e+'"]').addClass("active").siblings().removeClass("active")}),$("#tweetsSlider").owlCarousel({loop:!1,autoplay:!0,nav:!0,autoplayHoverPause:!1,margin:10,responsiveClass:!0,smartSpeed:600,navSpeed:600,responsive:{0:{items:1,nav:!0,loop:!0},600:{items:1,nav:!0,loop:!0},1000:{items:3,nav:!0,loop:!1,margin:50}}})}),function(){var e=$("#app-noise-cancellation-switch"),n=$("#app-play-button"),a=$("#app-play-state"),i=$("#app-pause-state"),o=$("#app-select-sound"),s=$("#app-playing-progress"),t=$("#app-app-environment-container"),l=$("#app-environment-image"),r=$("#app-take-listen"),d=$("#app-icon"),c=null,m=!1,p=-1,u=Cookies.get("app-guideStep")||"play",f=[{id:"backgroundMusicRemoval",name:"Background Music Removal"},{id:"coffeeshop",name:"Coffee Shop"}];function v(){$(".guide").addClass("hidden"),$("#guide-"+u).removeClass("hidden")}
function g(e){"finished"!==u&&(u=e,Cookies.set("app-guideStep",u,{expires:7}),v())}
function C(){var o=f[p];(c=new Sound(o.id)).on("loaded",function(){n.attr("disabled",!1).on("click",function(e){e.preventDefault(),g("switch"),(m=!m)?(a.addClass("hidden"),i.removeClass("hidden"),c.play()):(i.addClass("hidden"),a.removeClass("hidden"),c.pause())}),e.on("click",function(n){n.preventDefault(),g("finished"),e.toggleClass("on").toggleClass("off"),d.toggleClass("on").toggleClass("off"),c.clearNoise()})}),c.on("update",function(e,n){var a,i;a=e,i=n,s.width(Math.round(a/i*100)+"%")}),c.on("ended",function(){h(),m=!1}),l.find("img").removeClass("opaque").filter(":eq("+p+")").addClass("opaque"),l.find("img").attr("alt","Krisp"),t.removeClass().addClass("app-environment-container app-environment-"+o.id)}
function h(){i.addClass("hidden"),a.removeClass("hidden"),s.width(0)}
function b(){c&&(c.destroy(),h(),n.attr("disabled",!0).off("click"),i.addClass("hidden"),a.removeClass("hidden"),e.removeClass("on").addClass("off").off("click"),d.removeClass("on").addClass("off"),c=null,m=!1)}
v(),$("#mute-target").Morphext({animation:"flipInX",separator:"|",speed:3e3}),r.on("click",function(e){e.preventDefault(),$("html, body").animate({scrollTop:t.offset().top},500)}),o.on("click","span",function(e){var n=$(this).parent(),a=n.index();e.preventDefault(),a!==p&&(n.addClass("selected").siblings().removeClass("selected"),p=a,b(),C())}),o.append(f.map(function(e){return'<li><span  data-id="'+e.id+'">'+e.name+"</span></li>"})),l.append(f.map(function(e){return'<img src="'+"images/environments/bg-"+e.id+'.jpg" />'})),o.find("span:first").trigger("click")}();